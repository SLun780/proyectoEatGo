				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">EatGo | Principal</li>
						</ul><!-- /.breadcrumb -->
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title lighter">
													...
													EatGo Sistema de envio de comida a domicilio
												</h4>
											...
											<div class="widget-body">
												<div class="widget-main no-padding row">

													<center><img src="{{asset('images/Delivery.png')}}" align="center" width="20%"></center>
												</div><!-- /.widget-main -->
											</div><!-- /.widget-body -->
										</div><!-- /.widget-box -->
									</div><!-- /.col -->
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">EatGo</span>
							Application &copy; 2021 Project UTVT
						</span>
